...
_ROWS = {
    'show_planes': ('Show created planes', 'Erstellte Ebenen anzeigen', 'Afficher les plans créés', 'Mostrar los planos creados', 'Pokaż utworzone płaszczyzny'),
    'display_size': ('Minimum plane display size', 'Mindestgröße der Ebenendarstellung', 'Taille minimale d’affichage des plans', 'Tamaño mínimo de visualización del plano', 'Minimalny rozmiar wyświetlania płaszczyzny'),
    'display_size_hint': ('Display size only; longer names get more width. Enable Construction Plane Names in Fusion display settings. Label visibility also depends on zoom.', 'Nur Darstellungsgröße; längere Namen erhalten mehr Breite. Konstruktionsebenennamen in den Fusion-Anzeigeeinstellungen aktivieren. Die Namensanzeige hängt auch vom Zoom ab.', 'Taille d’affichage uniquement ; les noms longs disposent de plus de largeur. Activez les noms des plans de construction dans les paramètres d’affichage de Fusion. Leur visibilité dépend aussi du zoom.', 'Solo tamaño de visualización; los nombres largos reciben más anchura. Active los nombres de planos de construcción en los ajustes de visualización de Fusion. La visibilidad también depende del zoom.', 'Tylko rozmiar wyświetlania; dłuższe nazwy otrzymują większą szerokość. Włącz nazwy płaszczyzn konstrukcyjnych w ustawieniach wyświetlania Fusion. Widoczność zależy też od powiększenia.'),
